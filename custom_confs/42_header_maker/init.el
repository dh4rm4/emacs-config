...
(if (file-exists-p "~/.emacs.d/custom_confs/42_header_maker/string.el") (load-file "~/.emacs.d/custom_confs/42_header_maker/string.el"))
(if (file-exists-p "~/.emacs.d/custom_confs/42_header_maker/comments.el") (load-file "~/.emacs.d/custom_confs/42_header_maker/comments.el"))
(if (file-exists-p "~/.emacs.d/custom_confs/42_header_maker/header.el") (load-file "~/.emacs.d/custom_confs/42_header_maker/header.el"))
(if (file-exists-p "~/.emacs.d/custom_confs/42_header_maker/list.el") (load-file "~/.emacs.d/custom_confs/42_header_maker/list.el"))
...
;    Updated: 2019/10/17 14:41:43 by xwang            ###   ########.fr        ;
;                                                                              ;
;******************************************************************************;
...
; --------------------;
; USERNAME DEFINITION ;
(if (getenv "USERNAME_42")
  (defvar username_42 (getenv "USERNAME_42"))
  (defvar username_42 (getenv "USER"))
  )

(defvar 42_mail (concat username_42 "@student.42.fr"))


(set 'user-login username_42)
